...
public class UIUtil {
    ...
    public static void measureView(View v) {
        if(v.getHeight() == 0) {
            v.measure(MeasureSpec.makeMeasureSpec(getWindowWidth(v.getContext()), MeasureSpec.AT_MOST), MeasureSpec.makeMeasureSpec(Integer.MAX_VALUE, MeasureSpec.AT_MOST));
